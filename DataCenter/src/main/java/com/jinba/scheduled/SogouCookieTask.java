...
public class SogouCookieTask  implements Runnable {
  ...
  public void run() {
    ...
    List<Map<String, Object>> proxyList = this.dao.select(sql);
  ...
  public static SogouCookieEntity getResource() { SogouCookieEntity cookie = null;
  ...
  public static void returnResource(SogouCookieEntity cookie)
  {
